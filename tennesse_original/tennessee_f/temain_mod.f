...
C
      NN = 50
C
C  Set the number of points to simulate (60 points per minute - padrão = 172800)
C
      NPTS = 345600

C
C  Set the number of pints to simulate in steady state operation (padrão = 3600 * 8)
C
...
C
C
	OPEN(UNIT=111,FILE='./TE_data_inc.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=1111,FILE='./TE_data_mv1.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=1112,FILE='./TE_data_mv2.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=1113,FILE='./TE_data_mv3.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2111,FILE='./TE_data_me01.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2112,FILE='./TE_data_me02.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2113,FILE='./TE_data_me03.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2114,FILE='./TE_data_me04.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2115,FILE='./TE_data_me05.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2116,FILE='./TE_data_me06.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2117,FILE='./TE_data_me07.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2118,FILE='./TE_data_me08.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2119,FILE='./TE_data_me09.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2120,FILE='./TE_data_me10.dat',STATUS='new', IOSTAT=ios)
	OPEN(UNIT=2121,FILE='./TE_data_me11.dat',STATUS='new', IOSTAT=ios)
C
C
C  Simulation Loop
C
C  Escolher aqui quais perturbacoes irao acontecer
        DO 1000 I = 1, NPTS
         IF (I.GE.SSPTS) THEN
                 IDV(4)=1
          ENDIF
